package com.shivtej.tictactoe.utils
...
class Board {
    ...
    val isGameOver: Boolean
        get() = hasCompWon() || hasPlayerWon() || availableCells.isEmpty()

    fun hasCompWon(): Boolean {
    ...
    var compMove: Cells? = null
    fun miniMax(depth: Int, player: String): Int {
        if (hasCompWon()) return +1
    ...
    fun placeMove(cells: Cells, player: String) {
        board[cells.i][cells.j] = player
    }
}